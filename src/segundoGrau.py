...
enterVolta = src.misc.enterVolta;
erro = src.misc.erro;
fx = src.misc.fx;
valorParaX = src.misc.valorParaX;
valorParaA = src.misc.valorParaA;
valorParaB = src.misc.valorParaB;
valorParaC = src.misc.valorParaC;
opcoesSegundoGrau = {
    0 : "Calcular raízes",
